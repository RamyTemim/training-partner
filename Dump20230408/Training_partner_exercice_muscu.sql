...
CREATE TABLE `exercice_muscu` (
  ...
  KEY `fk_exerciceMuscu_1_idx` (`idseance`),
  CONSTRAINT `fk_exerciceMuscu_1` FOREIGN KEY (`idseance`) REFERENCES `seance` (`id_seance`) ON DELETE CASCADE ON UPDATE RESTRICT
